...
| [@noble/hashes](https://github.com/paulmillr/noble-hashes) © Paul Miller | 2.4.0 | MIT (`js/vendor/noble/LICENSE`) | `js/vendor/noble/{argon2,blake2,_blake,_md,_u64,utils}.js` — byte-for-byte upstream; pure-JavaScript Argon2id, used only when WebAssembly is unavailable | `e1946149b780017b2564fcc092cb01c04e1d7f20627d0296c17da8868f4436dc` |
